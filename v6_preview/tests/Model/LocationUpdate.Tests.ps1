...
Describe -tag 'PSOpenAPITools' -name 'LocationUpdate' {
    Context 'LocationUpdate' {
        It 'Initialize-LocationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LocationUpdate -Name "TEST_VALUE" -Latitude "TEST_VALUE" -Longitude "TEST_VALUE" -Description "TEST_VALUE"
