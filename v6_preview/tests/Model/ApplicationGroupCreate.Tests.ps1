...
Describe -tag 'PSOpenAPITools' -name 'ApplicationGroupCreate' {
    Context 'ApplicationGroupCreate' {
        It 'Initialize-ApplicationGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationGroupCreate -Name "TEST_VALUE" -Description "TEST_VALUE" -Steps "TEST_VALUE"
