...
Describe -tag 'PSOpenAPITools' -name 'AccountFilterGroup' {
    Context 'AccountFilterGroup' {
        It 'Initialize-AccountFilterGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountFilterGroup -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -GroupId "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Members "TEST_VALUE"
