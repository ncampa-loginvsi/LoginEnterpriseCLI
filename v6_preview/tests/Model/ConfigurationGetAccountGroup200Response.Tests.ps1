...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationGetAccountGroup200Response' {
    Context 'ConfigurationGetAccountGroup200Response' {
        It 'Initialize-ConfigurationGetAccountGroup200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationGetAccountGroup200Response -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -GroupId "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Members "TEST_VALUE"
