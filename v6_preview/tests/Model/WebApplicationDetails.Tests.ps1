...
Describe -tag 'PSOpenAPITools' -name 'WebApplicationDetails' {
    Context 'WebApplicationDetails' {
        It 'Initialize-WebApplicationDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-WebApplicationDetails -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE"
