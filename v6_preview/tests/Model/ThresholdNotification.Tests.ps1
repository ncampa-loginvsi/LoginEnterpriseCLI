...
Describe -tag 'PSOpenAPITools' -name 'ThresholdNotification' {
    Context 'ThresholdNotification' {
        It 'Initialize-ThresholdNotification' {
            # a simple test to create an object
            #$NewObject = Initialize-ThresholdNotification -Type "TEST_VALUE" -Threshold "TEST_VALUE" -Id "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -CooldownDuration "TEST_VALUE" -IsEnabled "TEST_VALUE"
