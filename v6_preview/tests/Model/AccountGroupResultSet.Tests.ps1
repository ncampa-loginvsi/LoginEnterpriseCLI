...
Describe -tag 'PSOpenAPITools' -name 'AccountGroupResultSet' {
    Context 'AccountGroupResultSet' {
        It 'Initialize-AccountGroupResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountGroupResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
