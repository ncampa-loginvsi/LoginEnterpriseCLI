...
Describe -tag 'PSOpenAPITools' -name 'ApplicationGroupInclude' {
    Context 'ApplicationGroupInclude' {
        It 'Initialize-ApplicationGroupInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationGroupInclude
