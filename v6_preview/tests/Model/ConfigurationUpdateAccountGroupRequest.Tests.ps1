...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationUpdateAccountGroupRequest' {
    Context 'ConfigurationUpdateAccountGroupRequest' {
        It 'Initialize-ConfigurationUpdateAccountGroupRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationUpdateAccountGroupRequest -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -MemberIds "TEST_VALUE"
