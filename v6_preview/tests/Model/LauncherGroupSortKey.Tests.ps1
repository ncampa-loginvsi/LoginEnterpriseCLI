...
Describe -tag 'PSOpenAPITools' -name 'LauncherGroupSortKey' {
    Context 'LauncherGroupSortKey' {
        It 'Initialize-LauncherGroupSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherGroupSortKey
