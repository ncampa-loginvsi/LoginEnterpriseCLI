...
Describe -tag 'PSOpenAPITools' -name 'AppInvocationCreate' {
    Context 'AppInvocationCreate' {
        It 'Initialize-AppInvocationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-AppInvocationCreate -Type "TEST_VALUE" -ApplicationId "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -IsEnabled "TEST_VALUE"
