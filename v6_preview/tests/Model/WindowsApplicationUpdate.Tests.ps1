...
Describe -tag 'PSOpenAPITools' -name 'WindowsApplicationUpdate' {
    Context 'WindowsApplicationUpdate' {
        It 'Initialize-WindowsApplicationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-WindowsApplicationUpdate -Type "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -MustUpdatePassword "TEST_VALUE" -ScriptContent "TEST_VALUE"
