...
Describe -tag 'PSOpenAPITools' -name 'LoadTestCreate' {
    Context 'LoadTestCreate' {
        It 'Initialize-LoadTestCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LoadTestCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Connector "TEST_VALUE" -AccountGroups "TEST_VALUE" -LauncherGroups "TEST_VALUE"
