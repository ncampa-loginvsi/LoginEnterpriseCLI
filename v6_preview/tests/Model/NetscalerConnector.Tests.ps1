...
Describe -tag 'PSOpenAPITools' -name 'NetscalerConnector' {
    Context 'NetscalerConnector' {
        It 'Initialize-NetscalerConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-NetscalerConnector -Type "TEST_VALUE" -ServerUrl "TEST_VALUE" -Resource "TEST_VALUE" -DisplayResolution "TEST_VALUE"
