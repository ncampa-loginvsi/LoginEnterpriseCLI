...
Describe -tag 'PSOpenAPITools' -name 'AccountSelectionGroup' {
    Context 'AccountSelectionGroup' {
        It 'Initialize-AccountSelectionGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountSelectionGroup -Type "TEST_VALUE" -GroupId "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Members "TEST_VALUE"
