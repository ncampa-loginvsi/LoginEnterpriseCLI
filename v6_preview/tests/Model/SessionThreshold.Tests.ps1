...
Describe -tag 'PSOpenAPITools' -name 'SessionThreshold' {
    Context 'SessionThreshold' {
        It 'Initialize-SessionThreshold' {
            # a simple test to create an object
            #$NewObject = Initialize-SessionThreshold -Type "TEST_VALUE" -Target "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE"
