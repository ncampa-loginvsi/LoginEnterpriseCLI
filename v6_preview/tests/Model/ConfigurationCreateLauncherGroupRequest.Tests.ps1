...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationCreateLauncherGroupRequest' {
    Context 'ConfigurationCreateLauncherGroupRequest' {
        It 'Initialize-ConfigurationCreateLauncherGroupRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationCreateLauncherGroupRequest -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -LauncherNames "TEST_VALUE"
