...
Describe -tag 'PSOpenAPITools' -name 'ApplicationGroupSortKey' {
    Context 'ApplicationGroupSortKey' {
        It 'Initialize-ApplicationGroupSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationGroupSortKey
