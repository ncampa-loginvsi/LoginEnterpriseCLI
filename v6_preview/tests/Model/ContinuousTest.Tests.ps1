...
Describe -tag 'PSOpenAPITools' -name 'ContinuousTest' {
    Context 'ContinuousTest' {
        It 'Initialize-ContinuousTest' {
            # a simple test to create an object
            #$NewObject = Initialize-ContinuousTest -Type "TEST_VALUE" -ScheduleType "TEST_VALUE" -ScheduleIntervalInMinutes "TEST_VALUE" -NumberOfSessions "TEST_VALUE" -EnableCustomScreenshots "TEST_VALUE" -RepeatCount "TEST_VALUE" -IsRepeatEnabled "TEST_VALUE" -IsEnabled "TEST_VALUE" -RestartOnComplete "TEST_VALUE" -AlertConfigurations "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -Environment "TEST_VALUE" -Workload "TEST_VALUE"
