...
Describe -tag 'PSOpenAPITools' -name 'SuccessCounts' {
    Context 'SuccessCounts' {
        It 'Initialize-SuccessCounts' {
            # a simple test to create an object
            #$NewObject = Initialize-SuccessCounts -SuccessCount "TEST_VALUE" -TotalCount "TEST_VALUE"
