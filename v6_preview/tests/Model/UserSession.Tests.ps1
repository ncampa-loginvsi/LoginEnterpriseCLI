...
Describe -tag 'PSOpenAPITools' -name 'UserSession' {
    Context 'UserSession' {
        It 'Initialize-UserSession' {
            # a simple test to create an object
            #$NewObject = Initialize-UserSession -Id "TEST_VALUE" -TestRunId "TEST_VALUE" -TestId "TEST_VALUE" -Created "TEST_VALUE" -LoginState "TEST_VALUE" -SessionState "TEST_VALUE" -StateLastModified "TEST_VALUE" -TestType "TEST_VALUE" -AccountId "TEST_VALUE" -LauncherName "TEST_VALUE" -LoginStartTime "TEST_VALUE" -LoginEndTime "TEST_VALUE" -SessionEndTime "TEST_VALUE" -Properties "TEST_VALUE"
