...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationGetLauncherGroup200Response' {
    Context 'ConfigurationGetLauncherGroup200Response' {
        It 'Initialize-ConfigurationGetLauncherGroup200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationGetLauncherGroup200Response -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Members "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE"
