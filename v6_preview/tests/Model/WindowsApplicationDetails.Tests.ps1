...
Describe -tag 'PSOpenAPITools' -name 'WindowsApplicationDetails' {
    Context 'WindowsApplicationDetails' {
        It 'Initialize-WindowsApplicationDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-WindowsApplicationDetails -Type "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
