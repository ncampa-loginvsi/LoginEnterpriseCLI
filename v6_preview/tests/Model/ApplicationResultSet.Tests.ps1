...
Describe -tag 'PSOpenAPITools' -name 'ApplicationResultSet' {
    Context 'ApplicationResultSet' {
        It 'Initialize-ApplicationResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
