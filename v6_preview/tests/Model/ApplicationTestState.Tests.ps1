...
Describe -tag 'PSOpenAPITools' -name 'ApplicationTestState' {
    Context 'ApplicationTestState' {
        It 'Initialize-ApplicationTestState' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationTestState
