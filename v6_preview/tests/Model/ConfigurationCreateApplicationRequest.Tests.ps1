...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationCreateApplicationRequest' {
    Context 'ConfigurationCreateApplicationRequest' {
        It 'Initialize-ConfigurationCreateApplicationRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationCreateApplicationRequest -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -ScriptContent "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
