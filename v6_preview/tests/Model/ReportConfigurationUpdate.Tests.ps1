...
Describe -tag 'PSOpenAPITools' -name 'ReportConfigurationUpdate' {
    Context 'ReportConfigurationUpdate' {
        It 'Initialize-ReportConfigurationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-ReportConfigurationUpdate -Name "TEST_VALUE" -Description "TEST_VALUE" -IsEnabled "TEST_VALUE" -Notification "TEST_VALUE"
