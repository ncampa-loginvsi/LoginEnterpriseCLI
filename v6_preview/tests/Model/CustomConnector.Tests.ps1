...
Describe -tag 'PSOpenAPITools' -name 'CustomConnector' {
    Context 'CustomConnector' {
        It 'Initialize-CustomConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-CustomConnector -Type "TEST_VALUE" -VarHost "TEST_VALUE" -CommandLine "TEST_VALUE" -Resource "TEST_VALUE"
