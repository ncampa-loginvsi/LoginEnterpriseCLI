...
Describe -tag 'PSOpenAPITools' -name 'ContinuousTestUpdate' {
    Context 'ContinuousTestUpdate' {
        It 'Initialize-ContinuousTestUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-ContinuousTestUpdate -Type "TEST_VALUE" -ScheduleType "TEST_VALUE" -IntervalInMinutes "TEST_VALUE" -NumberOfSessions "TEST_VALUE" -EnableCustomScreenshots "TEST_VALUE" -RepeatCount "TEST_VALUE" -IsRepeatEnabled "TEST_VALUE" -IsEnabled "TEST_VALUE" -RestartOnComplete "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -EnvironmentUpdate "TEST_VALUE" -Steps "TEST_VALUE"
