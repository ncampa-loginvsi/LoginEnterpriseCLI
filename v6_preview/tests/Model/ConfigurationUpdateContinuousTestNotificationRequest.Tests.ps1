...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationUpdateContinuousTestNotificationRequest' {
    Context 'ConfigurationUpdateContinuousTestNotificationRequest' {
        It 'Initialize-ConfigurationUpdateContinuousTestNotificationRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationUpdateContinuousTestNotificationRequest -Type "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -ThresholdUpdate "TEST_VALUE"
