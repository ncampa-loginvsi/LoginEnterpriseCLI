...
Describe -tag 'PSOpenAPITools' -name 'ContinuousTestCreate' {
    Context 'ContinuousTestCreate' {
        It 'Initialize-ContinuousTestCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-ContinuousTestCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Connector "TEST_VALUE" -AccountGroups "TEST_VALUE" -LauncherGroups "TEST_VALUE"
