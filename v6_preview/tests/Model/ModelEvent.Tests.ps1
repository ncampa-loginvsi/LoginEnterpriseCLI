...
Describe -tag 'PSOpenAPITools' -name 'ModelEvent' {
    Context 'ModelEvent' {
        It 'Initialize-ModelEvent' {
            # a simple test to create an object
            #$NewObject = Initialize-ModelEvent -Id "TEST_VALUE" -EventType "TEST_VALUE" -Timestamp "TEST_VALUE" -Title "TEST_VALUE" -TestId "TEST_VALUE" -TestRunId "TEST_VALUE" -UserSessionId "TEST_VALUE" -ApplicationId "TEST_VALUE" -Properties "TEST_VALUE"
