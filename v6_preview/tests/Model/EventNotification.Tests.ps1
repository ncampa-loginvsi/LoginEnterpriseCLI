...
Describe -tag 'PSOpenAPITools' -name 'EventNotification' {
    Context 'EventNotification' {
        It 'Initialize-EventNotification' {
            # a simple test to create an object
            #$NewObject = Initialize-EventNotification -Type "TEST_VALUE" -VarEvent "TEST_VALUE" -LastModified "TEST_VALUE" -Id "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -CooldownDuration "TEST_VALUE" -IsEnabled "TEST_VALUE"
