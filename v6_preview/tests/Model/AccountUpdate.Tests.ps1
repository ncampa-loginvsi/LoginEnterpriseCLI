...
Describe -tag 'PSOpenAPITools' -name 'AccountUpdate' {
    Context 'AccountUpdate' {
        It 'Initialize-AccountUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountUpdate -Password "TEST_VALUE" -Username "TEST_VALUE" -Domain "TEST_VALUE" -Email "TEST_VALUE" -Fields "TEST_VALUE"
