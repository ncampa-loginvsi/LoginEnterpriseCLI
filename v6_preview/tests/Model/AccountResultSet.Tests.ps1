...
Describe -tag 'PSOpenAPITools' -name 'AccountResultSet' {
    Context 'AccountResultSet' {
        It 'Initialize-AccountResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
