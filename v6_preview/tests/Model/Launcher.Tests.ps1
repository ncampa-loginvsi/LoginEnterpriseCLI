...
Describe -tag 'PSOpenAPITools' -name 'Launcher' {
    Context 'Launcher' {
        It 'Initialize-Launcher' {
            # a simple test to create an object
            #$NewObject = Initialize-Launcher -MachineName "TEST_VALUE" -SupportedVersion "TEST_VALUE" -Sessions "TEST_VALUE" -CurrentVersion "TEST_VALUE" -Online "TEST_VALUE" -FirstSeen "TEST_VALUE" -LastStateChange "TEST_VALUE" -Properties "TEST_VALUE" -Groups "TEST_VALUE" -LocationId "TEST_VALUE"
