...
Describe -tag 'PSOpenAPITools' -name 'AccountFilterGroupUpdate' {
    Context 'AccountFilterGroupUpdate' {
        It 'Initialize-AccountFilterGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountFilterGroupUpdate -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
