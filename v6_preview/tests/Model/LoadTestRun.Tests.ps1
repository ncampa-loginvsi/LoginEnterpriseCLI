...
Describe -tag 'PSOpenAPITools' -name 'LoadTestRun' {
    Context 'LoadTestRun' {
        It 'Initialize-LoadTestRun' {
            # a simple test to create an object
            #$NewObject = Initialize-LoadTestRun -Type "TEST_VALUE" -State "TEST_VALUE" -Result "TEST_VALUE" -RampUpCompleted "TEST_VALUE" -ActiveSessionCount "TEST_VALUE" -StatisticsReady "TEST_VALUE" -ProductVersion "TEST_VALUE" -LoginCounts "TEST_VALUE" -EngineCounts "TEST_VALUE" -AppExecutionCounts "TEST_VALUE" -EuxScore "TEST_VALUE" -VsiMax "TEST_VALUE" -Comment "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -Created "TEST_VALUE" -Started "TEST_VALUE" -Finished "TEST_VALUE" -Counter "TEST_VALUE"
