...
Describe -tag 'PSOpenAPITools' -name 'ContinuousTestRun' {
    Context 'ContinuousTestRun' {
        It 'Initialize-ContinuousTestRun' {
            # a simple test to create an object
            #$NewObject = Initialize-ContinuousTestRun -Type "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -Created "TEST_VALUE" -Started "TEST_VALUE" -Finished "TEST_VALUE" -Counter "TEST_VALUE"
