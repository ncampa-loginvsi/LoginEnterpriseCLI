...
Describe -tag 'PSOpenAPITools' -name 'ApplicationTest' {
    Context 'ApplicationTest' {
        It 'Initialize-ApplicationTest' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationTest -Type "TEST_VALUE" -IsEmailEnabled "TEST_VALUE" -EmailRecipient "TEST_VALUE" -IncludeSuccessfulApplications "TEST_VALUE" -State "TEST_VALUE" -Thresholds "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -Environment "TEST_VALUE" -Workload "TEST_VALUE"
