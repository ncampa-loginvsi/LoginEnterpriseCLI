...
Describe -tag 'PSOpenAPITools' -name 'ReportConfigurationResultSet' {
    Context 'ReportConfigurationResultSet' {
        It 'Initialize-ReportConfigurationResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-ReportConfigurationResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
