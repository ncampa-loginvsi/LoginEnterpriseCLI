...
Describe -tag 'PSOpenAPITools' -name 'LauncherGroupInclude' {
    Context 'LauncherGroupInclude' {
        It 'Initialize-LauncherGroupInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherGroupInclude
