...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationReplaceApplicationGroupStepsRequestInner' {
    Context 'ConfigurationReplaceApplicationGroupStepsRequestInner' {
        It 'Initialize-ConfigurationReplaceApplicationGroupStepsRequestInner' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationReplaceApplicationGroupStepsRequestInner -Type "TEST_VALUE" -ApplicationId "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -IsEnabled "TEST_VALUE" -DelayInSeconds "TEST_VALUE" -ApplicationGroupId "TEST_VALUE"
