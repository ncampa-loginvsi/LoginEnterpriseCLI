...
Describe -tag 'PSOpenAPITools' -name 'ReportResultSet' {
    Context 'ReportResultSet' {
        It 'Initialize-ReportResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-ReportResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
