...
Describe -tag 'PSOpenAPITools' -name 'LauncherProperty' {
    Context 'LauncherProperty' {
        It 'Initialize-LauncherProperty' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherProperty -PropertyId "TEST_VALUE" -Value "TEST_VALUE"
