...
Describe -tag 'PSOpenAPITools' -name 'EventResultSet' {
    Context 'EventResultSet' {
        It 'Initialize-EventResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-EventResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
