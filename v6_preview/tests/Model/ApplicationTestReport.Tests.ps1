...
Describe -tag 'PSOpenAPITools' -name 'ApplicationTestReport' {
    Context 'ApplicationTestReport' {
        It 'Initialize-ApplicationTestReport' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationTestReport -Type "TEST_VALUE" -TestRunId "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -OutputContentUri "TEST_VALUE" -State "TEST_VALUE" -Trigger "TEST_VALUE" -Created "TEST_VALUE" -ReportPeriodStart "TEST_VALUE" -ReportPeriodEnd "TEST_VALUE"
