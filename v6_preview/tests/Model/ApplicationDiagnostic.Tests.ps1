...
Describe -tag 'PSOpenAPITools' -name 'ApplicationDiagnostic' {
    Context 'ApplicationDiagnostic' {
        It 'Initialize-ApplicationDiagnostic' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationDiagnostic -ApplicationId "TEST_VALUE" -ApplicationName "TEST_VALUE" -AboveThreshold "TEST_VALUE" -TotalMeasurements "TEST_VALUE" -Percentage "TEST_VALUE"
