...
Describe -tag 'PSOpenAPITools' -name 'ApplicationGroup' {
    Context 'ApplicationGroup' {
        It 'Initialize-ApplicationGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationGroup -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -MemberCount "TEST_VALUE" -Steps "TEST_VALUE"
