...
Describe -tag 'PSOpenAPITools' -name 'ReportConfigurationSortKey' {
    Context 'ReportConfigurationSortKey' {
        It 'Initialize-ReportConfigurationSortKey' {
            # a simple test to create an object
            #$NewObject = Initialize-ReportConfigurationSortKey
