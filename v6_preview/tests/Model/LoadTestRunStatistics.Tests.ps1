...
Describe -tag 'PSOpenAPITools' -name 'LoadTestRunStatistics' {
    Context 'LoadTestRunStatistics' {
        It 'Initialize-LoadTestRunStatistics' {
            # a simple test to create an object
            #$NewObject = Initialize-LoadTestRunStatistics -EuxScores "TEST_VALUE" -BaseTimestamp "TEST_VALUE" -VsiMaxOffset "TEST_VALUE"
