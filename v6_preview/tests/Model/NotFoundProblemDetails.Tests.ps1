...
Describe -tag 'PSOpenAPITools' -name 'NotFoundProblemDetails' {
    Context 'NotFoundProblemDetails' {
        It 'Initialize-NotFoundProblemDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-NotFoundProblemDetails -NotFound "TEST_VALUE" -Type "TEST_VALUE" -Title "TEST_VALUE" -Status "TEST_VALUE" -Detail "TEST_VALUE" -Instance "TEST_VALUE"
