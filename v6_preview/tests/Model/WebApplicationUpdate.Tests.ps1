...
Describe -tag 'PSOpenAPITools' -name 'WebApplicationUpdate' {
    Context 'WebApplicationUpdate' {
        It 'Initialize-WebApplicationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-WebApplicationUpdate -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE" -MustUpdatePassword "TEST_VALUE" -ScriptContent "TEST_VALUE"
