...
Describe -tag 'PSOpenAPITools' -name 'MeasurementResultSet' {
    Context 'MeasurementResultSet' {
        It 'Initialize-MeasurementResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-MeasurementResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
