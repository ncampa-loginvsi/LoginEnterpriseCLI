...
Describe -tag 'PSOpenAPITools' -name 'DelayUpdate' {
    Context 'DelayUpdate' {
        It 'Initialize-DelayUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-DelayUpdate -Type "TEST_VALUE" -DelayInSeconds "TEST_VALUE" -IsEnabled "TEST_VALUE"
