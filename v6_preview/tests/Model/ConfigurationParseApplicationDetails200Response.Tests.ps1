...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationParseApplicationDetails200Response' {
    Context 'ConfigurationParseApplicationDetails200Response' {
        It 'Initialize-ConfigurationParseApplicationDetails200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationParseApplicationDetails200Response -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE"
