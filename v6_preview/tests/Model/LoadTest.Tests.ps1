...
Describe -tag 'PSOpenAPITools' -name 'LoadTest' {
    Context 'LoadTest' {
        It 'Initialize-LoadTest' {
            # a simple test to create an object
            #$NewObject = Initialize-LoadTest -Type "TEST_VALUE" -NumberOfSessions "TEST_VALUE" -RampUpDurationInMinutes "TEST_VALUE" -TestDurationInMinutes "TEST_VALUE" -RampDownDurationInMinutes "TEST_VALUE" -State "TEST_VALUE" -EuxEnabled "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Created "TEST_VALUE" -Environment "TEST_VALUE" -Workload "TEST_VALUE"
