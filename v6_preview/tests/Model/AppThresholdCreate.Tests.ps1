...
Describe -tag 'PSOpenAPITools' -name 'AppThresholdCreate' {
    Context 'AppThresholdCreate' {
        It 'Initialize-AppThresholdCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-AppThresholdCreate -ApplicationId "TEST_VALUE" -Timer "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE"
