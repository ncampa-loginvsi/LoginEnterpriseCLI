...
Describe -tag 'PSOpenAPITools' -name 'WebApplication' {
    Context 'WebApplication' {
        It 'Initialize-WebApplication' {
            # a simple test to create an object
            #$NewObject = Initialize-WebApplication -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Script "TEST_VALUE" -Timers "TEST_VALUE"
