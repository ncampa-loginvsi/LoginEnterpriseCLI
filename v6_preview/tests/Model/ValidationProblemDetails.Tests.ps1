...
Describe -tag 'PSOpenAPITools' -name 'ValidationProblemDetails' {
    Context 'ValidationProblemDetails' {
        It 'Initialize-ValidationProblemDetails' {
            # a simple test to create an object
            #$NewObject = Initialize-ValidationProblemDetails -Errors "TEST_VALUE" -Type "TEST_VALUE" -Title "TEST_VALUE" -Status "TEST_VALUE" -Detail "TEST_VALUE" -Instance "TEST_VALUE"
