...
Describe -tag 'PSOpenAPITools' -name 'EnvironmentUpdateConnector' {
    Context 'EnvironmentUpdateConnector' {
        It 'Initialize-EnvironmentUpdateConnector' {
            ...
            #$NewObject = Initialize-EnvironmentUpdateConnector -Type "TEST_VALUE" -VarHost "TEST_VALUE" -CommandLine "TEST_VALUE" -Resource "TEST_VALUE" -ServerUrl "TEST_VALUE" -DisplayResolution "TEST_VALUE" -HostList "TEST_VALUE" -Gateway "TEST_VALUE" -SuppressCertWarn "TEST_VALUE"
