...
Describe -tag 'PSOpenAPITools' -name 'TestRunResultSet' {
    Context 'TestRunResultSet' {
        It 'Initialize-TestRunResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-TestRunResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
