...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationGetApplicationTestThresholds200ResponseInner' {
    Context 'ConfigurationGetApplicationTestThresholds200ResponseInner' {
        It 'Initialize-ConfigurationGetApplicationTestThresholds200ResponseInner' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationGetApplicationTestThresholds200ResponseInner -Type "TEST_VALUE" -ApplicationId "TEST_VALUE" -Timer "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -Target "TEST_VALUE"
