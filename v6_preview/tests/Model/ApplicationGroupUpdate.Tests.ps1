...
Describe -tag 'PSOpenAPITools' -name 'ApplicationGroupUpdate' {
    Context 'ApplicationGroupUpdate' {
        It 'Initialize-ApplicationGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationGroupUpdate -Name "TEST_VALUE" -Description "TEST_VALUE" -Steps "TEST_VALUE"
