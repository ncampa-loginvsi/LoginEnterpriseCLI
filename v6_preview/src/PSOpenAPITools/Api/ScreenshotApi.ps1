...
function Invoke-DataGetScreenshotByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/app-executions/{appExecutionId}/screenshots/{screenshotId}'
        if (!$TestRunId) {
...
function Invoke-DataGetScreenshotByEvent {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/events/{eventId}/screenshots'
        if (!$TestRunId) {
...
function Invoke-DataGetScreenshotsByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/app-executions/{appExecutionId}/screenshots'
        if (!$TestRunId) {
