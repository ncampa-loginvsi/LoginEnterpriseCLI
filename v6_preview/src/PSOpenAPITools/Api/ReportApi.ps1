...
function Invoke-DataDownloadApplicationTestReport {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/reports/pdf'
        if (!$TestRunId) {
...
function Invoke-DataDownloadContinuousTestReport {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/reports/{reportId}/pdf'
        if (!$ReportId) {
...
function Invoke-DataGetApplicationTestReport {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/reports'
        if (!$TestRunId) {
...
function Invoke-DataGetContinuousTestReport {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/reports/{reportId}'
        if (!$ReportId) {
...
function Invoke-DataGetContinuousTestReports {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/tests/{testId}/report-configurations/{configurationId}/reports'
        if (!$TestId) {
