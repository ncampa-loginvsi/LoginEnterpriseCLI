...
function Invoke-DataGetMeasurements {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/measurements'
        if (!$TestRunId) {
        ...
        if (!$Direction) {
            throw "Error! The required parameter `Direction` missing when calling dataGetMeasurements."
        }
        $LocalVarQueryParameters['direction'] = $Direction

        if (!$Count) {
            throw "Error! The required parameter `Count` missing when calling dataGetMeasurements."
        }
...
function Invoke-DataGetMeasurementsByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/app-executions/{appExecutionId}/measurements'
        if (!$TestRunId) {
        ...
        if (!$Direction) {
            throw "Error! The required parameter `Direction` missing when calling dataGetMeasurementsByAppExecution."
        }
        $LocalVarQueryParameters['direction'] = $Direction

        if (!$Count) {
            throw "Error! The required parameter `Count` missing when calling dataGetMeasurementsByAppExecution."
        }
        $LocalVarQueryParameters['count'] = $Count
...
function Invoke-DataGetMeasurementsByUserSession {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/user-sessions/{userSessionId}/measurements'
        if (!$TestRunId) {
        ...
        if (!$Direction) {
            throw "Error! The required parameter `Direction` missing when calling dataGetMeasurementsByUserSession."
        }
        $LocalVarQueryParameters['direction'] = $Direction

        if (!$Count) {
            throw "Error! The required parameter `Count` missing when calling dataGetMeasurementsByUserSession."
        }
        $LocalVarQueryParameters['count'] = $Count
