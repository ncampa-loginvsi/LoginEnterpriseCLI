...
function Invoke-DataGetLoadTestRunStatistics {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/statistics'
        if (!$TestRunId) {
...
function Invoke-DataGetTestRun {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}'
        if (!$TestRunId) {
...
function Invoke-DataGetTestRuns {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/tests/{testId}/test-runs'
        if (!$TestId) {
        ...
        if (!$Direction) {
            throw "Error! The required parameter `Direction` missing when calling dataGetTestRuns."
        }
        $LocalVarQueryParameters['direction'] = $Direction

        if (!$Count) {
            throw "Error! The required parameter `Count` missing when calling dataGetTestRuns."
        }
