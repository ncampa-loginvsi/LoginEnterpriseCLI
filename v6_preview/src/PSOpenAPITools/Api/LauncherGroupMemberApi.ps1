...
function Invoke-ConfigurationAddLauncherGroupMembers {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/launcher-groups/{groupId}/members'
        if (!$GroupId) {
...
function Invoke-ConfigurationGetLauncherGroupMembers {
    ...
    Process {
        ...
        if (!$OrderBy) {
            throw "Error! The required parameter `OrderBy` missing when calling configurationGetLauncherGroupMembers."
        }
        $LocalVarQueryParameters['orderBy'] = $OrderBy

        if (!$Direction) {
            throw "Error! The required parameter `Direction` missing when calling configurationGetLauncherGroupMembers."
        }
        $LocalVarQueryParameters['direction'] = $Direction

        if (!$Count) {
            throw "Error! The required parameter `Count` missing when calling configurationGetLauncherGroupMembers."
        }
