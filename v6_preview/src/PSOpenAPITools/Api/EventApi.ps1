...
function Invoke-DataGetEvent {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/events/{eventId}'
        if (!$EventId) {
...
function Invoke-DataGetEvents {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/events'
        if (!$TestRunId) {
...
function Invoke-DataGetEventsByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/app-executions/{appExecutionId}/events'
        if (!$TestRunId) {
...
function Invoke-DataGetEventsByUserSession {
    ...
    Process {
        ...
        $LocalVarUri = '/v6-preview/test-runs/{testRunId}/user-sessions/{userSessionId}/events'
        if (!$TestRunId) {
