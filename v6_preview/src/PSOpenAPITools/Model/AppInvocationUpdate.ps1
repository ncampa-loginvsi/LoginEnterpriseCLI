...
function Initialize-AppInvocationUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppInvocationUpdate' | Write-Debug
...
function ConvertFrom-JsonToAppInvocationUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppInvocationUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
