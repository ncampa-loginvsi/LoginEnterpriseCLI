...
function Initialize-AccountGroupResultSet {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountGroupResultSet' | Write-Debug
...
function ConvertFrom-JsonToAccountGroupResultSet {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountGroupResultSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
