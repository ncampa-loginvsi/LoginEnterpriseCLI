...
function Initialize-ContinuousTestCreate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContinuousTestCreate' | Write-Debug
...
function ConvertFrom-JsonToContinuousTestCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContinuousTestCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
