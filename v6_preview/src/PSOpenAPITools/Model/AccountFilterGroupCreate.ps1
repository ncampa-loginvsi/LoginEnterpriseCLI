...
function Initialize-AccountFilterGroupCreate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountFilterGroupCreate' | Write-Debug
...
function ConvertFrom-JsonToAccountFilterGroupCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountFilterGroupCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
