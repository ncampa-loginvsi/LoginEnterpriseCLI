...
function Initialize-WebApplicationUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebApplicationUpdate' | Write-Debug
...
function ConvertFrom-JsonToWebApplicationUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebApplicationUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebApplicationUpdate
        $AllProperties = ("type", "browserName", "url", "name", "description", "username", "password", "mustUpdatePassword", "scriptContent")
