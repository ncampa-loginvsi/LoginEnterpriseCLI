...
function Initialize-ApplicationGroupUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationGroupUpdate' | Write-Debug
...
function ConvertFrom-JsonToApplicationGroupUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationGroupUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
