...
function Initialize-WindowsApplicationUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WindowsApplicationUpdate' | Write-Debug
...
function ConvertFrom-JsonToWindowsApplicationUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WindowsApplicationUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WindowsApplicationUpdate
        $AllProperties = ("type", "commandLine", "workingDirectory", "name", "description", "username", "password", "mustUpdatePassword", "scriptContent")
