...
function Initialize-AppGroupReferenceUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppGroupReferenceUpdate' | Write-Debug
...
function ConvertFrom-JsonToAppGroupReferenceUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppGroupReferenceUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
