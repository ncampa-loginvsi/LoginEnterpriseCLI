...
function Initialize-LoadTestRunStatistics {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoadTestRunStatistics' | Write-Debug
...
function ConvertFrom-JsonToLoadTestRunStatistics {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoadTestRunStatistics' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
