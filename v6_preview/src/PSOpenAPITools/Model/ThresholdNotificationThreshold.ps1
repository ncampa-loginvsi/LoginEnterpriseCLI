...
#>
function ConvertFrom-JsonToThresholdNotificationThreshold {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'AppThreshold' defined in oneOf (ThresholdNotificationThreshold). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'SessionThreshold' defined in oneOf (ThresholdNotificationThreshold). Proceeding to the next one if any."
        }
