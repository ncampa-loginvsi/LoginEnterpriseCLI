...
function Initialize-ApplicationGroupResultSet {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationGroupResultSet' | Write-Debug
...
function ConvertFrom-JsonToApplicationGroupResultSet {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationGroupResultSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
