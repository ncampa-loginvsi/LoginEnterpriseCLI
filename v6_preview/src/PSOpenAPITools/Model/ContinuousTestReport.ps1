...
function Initialize-ContinuousTestReport {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContinuousTestReport' | Write-Debug
...
function ConvertFrom-JsonToContinuousTestReport {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContinuousTestReport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
