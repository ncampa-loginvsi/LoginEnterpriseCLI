...
function Initialize-LauncherFilterGroupData {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LauncherFilterGroupData' | Write-Debug
...
function ConvertFrom-JsonToLauncherFilterGroupData {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LauncherFilterGroupData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
