...
function Initialize-WebApplicationDetails {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebApplicationDetails' | Write-Debug
...
function ConvertFrom-JsonToWebApplicationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebApplicationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
