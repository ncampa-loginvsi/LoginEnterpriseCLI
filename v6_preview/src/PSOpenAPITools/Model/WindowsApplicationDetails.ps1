...
function Initialize-WindowsApplicationDetails {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WindowsApplicationDetails' | Write-Debug
...
function ConvertFrom-JsonToWindowsApplicationDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WindowsApplicationDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
