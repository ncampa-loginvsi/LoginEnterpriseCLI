...
function Initialize-ReportConfigurationResultSet {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReportConfigurationResultSet' | Write-Debug
...
function ConvertFrom-JsonToReportConfigurationResultSet {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReportConfigurationResultSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
