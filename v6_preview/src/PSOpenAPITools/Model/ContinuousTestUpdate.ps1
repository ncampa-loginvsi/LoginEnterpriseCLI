...
function Initialize-ContinuousTestUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ContinuousTestUpdate' | Write-Debug
...
function ConvertFrom-JsonToContinuousTestUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ContinuousTestUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ContinuousTestUpdate
        $AllProperties = ("type", "scheduleType", "intervalInMinutes", "numberOfSessions", "enableCustomScreenshots", "repeatCount", "isRepeatEnabled", "isEnabled", "restartOnComplete", "name", "description", "environmentUpdate", "steps")
