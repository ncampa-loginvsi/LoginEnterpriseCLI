...
function Initialize-ApplicationDiagnostic {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationDiagnostic' | Write-Debug
...
function ConvertFrom-JsonToApplicationDiagnostic {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationDiagnostic' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
