...
function Initialize-LauncherSelectionGroup {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LauncherSelectionGroup' | Write-Debug
...
function ConvertFrom-JsonToLauncherSelectionGroup {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LauncherSelectionGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
