...
function Initialize-WebApplicationCreate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebApplicationCreate' | Write-Debug
...
function ConvertFrom-JsonToWebApplicationCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebApplicationCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebApplicationCreate
        $AllProperties = ("type", "browserName", "url", "name", "description", "username", "password", "scriptContent")
