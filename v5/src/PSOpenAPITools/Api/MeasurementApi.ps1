...
function Invoke-DataGetMeasurements {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/test-runs/{testRunId}/measurements'
        if (!$TestRunId) {
...
function Invoke-DataGetMeasurementsByAppExecution {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/test-runs/{testRunId}/app-executions/{appExecutionId}/measurements'
        if (!$TestRunId) {
...
function Invoke-DataGetMeasurementsByUserSession {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/test-runs/{testRunId}/user-sessions/{userSessionId}/measurements'
        if (!$TestRunId) {
