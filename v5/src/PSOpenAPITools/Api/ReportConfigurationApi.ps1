...
function Invoke-ConfigurationCreateReportConfiguration {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/tests/{testId}/report-configurations'
        if (!$TestId) {
...
function Invoke-ConfigurationCreateReportConfigurationThreshold {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/tests/{testId}/report-configurations/{configurationId}/thresholds'
        if (!$TestId) {
...
function Invoke-ConfigurationDeleteReportConfiguration {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/tests/{testId}/report-configurations/{configurationId}'
        if (!$TestId) {
...
function Invoke-ConfigurationDeleteReportConfigurationLogo {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/tests/{testId}/report-configurations/{configurationId}/logo'
        if (!$TestId) {
...
function Invoke-ConfigurationDeleteReportConfigurationThreshold {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/tests/{testId}/report-configurations/{configurationId}/thresholds/{thresholdId}'
        if (!$TestId) {
...
function Invoke-ConfigurationRequestReport {
    ...
    Process {
        ...
        $LocalVarUri = '/v5/tests/{testId}/report-configurations/{configurationId}/report-request'
        if (!$TestId) {
