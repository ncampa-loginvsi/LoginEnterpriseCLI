...
function Initialize-AccountSelectionGroupUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountSelectionGroupUpdate' | Write-Debug
...
function ConvertFrom-JsonToAccountSelectionGroupUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountSelectionGroupUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
