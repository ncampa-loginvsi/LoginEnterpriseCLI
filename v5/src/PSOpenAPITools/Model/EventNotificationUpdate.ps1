...
function Initialize-EventNotificationUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EventNotificationUpdate' | Write-Debug
...
function ConvertFrom-JsonToEventNotificationUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EventNotificationUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
