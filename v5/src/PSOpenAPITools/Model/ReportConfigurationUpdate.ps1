...
function Initialize-ReportConfigurationUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ReportConfigurationUpdate' | Write-Debug
...
function ConvertFrom-JsonToReportConfigurationUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ReportConfigurationUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
