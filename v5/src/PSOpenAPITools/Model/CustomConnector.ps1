...
function Initialize-CustomConnector {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CustomConnector' | Write-Debug
...
function ConvertFrom-JsonToCustomConnector {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CustomConnector' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CustomConnector
        $AllProperties = ("type", "host", "commandLine")
