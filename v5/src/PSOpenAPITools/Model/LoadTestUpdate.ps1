...
function Initialize-LoadTestUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoadTestUpdate' | Write-Debug
...
function ConvertFrom-JsonToLoadTestUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoadTestUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoadTestUpdate
        $AllProperties = ("type", "numberOfSessions", "rampUpDurationInMinutes", "testDurationInMinutes", "name", "description", "environmentUpdate", "steps")
