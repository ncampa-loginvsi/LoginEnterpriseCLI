...
function Initialize-LoadTestRun {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoadTestRun' | Write-Debug
...
function ConvertFrom-JsonToLoadTestRun {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoadTestRun' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoadTestRun
        $AllProperties = ("type", "state", "result", "rampUpCompleted", "activeSessionCount", "statisticsReady", "productVersion", "loginCounts", "engineCounts", "appExecutionCounts", "comment", "id", "testId", "created", "started", "finished", "counter")
