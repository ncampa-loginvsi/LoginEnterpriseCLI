...
#>
function ConvertFrom-JsonToEnvironmentUpdateConnector {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'CustomConnector' defined in oneOf (EnvironmentUpdateConnector). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'DesktopConnector' defined in oneOf (EnvironmentUpdateConnector). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'HorizonConnector' defined in oneOf (EnvironmentUpdateConnector). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'NetscalerConnector' defined in oneOf (EnvironmentUpdateConnector). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'RdpConnector' defined in oneOf (EnvironmentUpdateConnector). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'StorefrontConnector' defined in oneOf (EnvironmentUpdateConnector). Proceeding to the next one if any."
        }
