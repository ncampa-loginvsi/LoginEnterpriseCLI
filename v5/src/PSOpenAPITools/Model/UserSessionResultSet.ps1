...
function Initialize-UserSessionResultSet {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserSessionResultSet' | Write-Debug
...
function ConvertFrom-JsonToUserSessionResultSet {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserSessionResultSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
