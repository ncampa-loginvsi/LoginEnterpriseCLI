...
function Initialize-AppGroupReferenceCreate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppGroupReferenceCreate' | Write-Debug
...
function ConvertFrom-JsonToAppGroupReferenceCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppGroupReferenceCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
