...
function Initialize-AppExecutionResultSet {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AppExecutionResultSet' | Write-Debug
...
function ConvertFrom-JsonToAppExecutionResultSet {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AppExecutionResultSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
