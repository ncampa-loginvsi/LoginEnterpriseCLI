...
function Initialize-AccountFilterGroupUpdate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AccountFilterGroupUpdate' | Write-Debug
...
function ConvertFrom-JsonToAccountFilterGroupUpdate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AccountFilterGroupUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
