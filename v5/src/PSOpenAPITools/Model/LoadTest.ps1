...
function Initialize-LoadTest {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LoadTest' | Write-Debug
...
function ConvertFrom-JsonToLoadTest {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LoadTest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LoadTest
        $AllProperties = ("type", "numberOfSessions", "rampUpDurationInMinutes", "testDurationInMinutes", "rampDownDurationInMinutes", "state", "id", "name", "description", "created", "environment", "workload")
