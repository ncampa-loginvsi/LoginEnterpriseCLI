...
function Initialize-MeasurementResultSet {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MeasurementResultSet' | Write-Debug
...
function ConvertFrom-JsonToMeasurementResultSet {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MeasurementResultSet' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
