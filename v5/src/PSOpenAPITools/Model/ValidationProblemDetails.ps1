...
function Initialize-ValidationProblemDetails {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ValidationProblemDetails' | Write-Debug
...
function ConvertFrom-JsonToValidationProblemDetails {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ValidationProblemDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
