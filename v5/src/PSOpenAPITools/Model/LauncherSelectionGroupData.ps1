...
function Initialize-LauncherSelectionGroupData {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LauncherSelectionGroupData' | Write-Debug
...
function ConvertFrom-JsonToLauncherSelectionGroupData {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LauncherSelectionGroupData' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
