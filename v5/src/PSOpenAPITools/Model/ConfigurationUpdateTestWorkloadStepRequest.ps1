...
#>
function ConvertFrom-JsonToConfigurationUpdateTestWorkloadStepRequest {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'AppGroupReferenceUpdate' defined in oneOf (ConfigurationUpdateTestWorkloadStepRequest). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'AppInvocationUpdate' defined in oneOf (ConfigurationUpdateTestWorkloadStepRequest). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'DelayUpdate' defined in oneOf (ConfigurationUpdateTestWorkloadStepRequest). Proceeding to the next one if any."
        }
