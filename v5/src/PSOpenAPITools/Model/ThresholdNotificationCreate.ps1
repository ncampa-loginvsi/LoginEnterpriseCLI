...
function Initialize-ThresholdNotificationCreate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ThresholdNotificationCreate' | Write-Debug
...
function ConvertFrom-JsonToThresholdNotificationCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ThresholdNotificationCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
