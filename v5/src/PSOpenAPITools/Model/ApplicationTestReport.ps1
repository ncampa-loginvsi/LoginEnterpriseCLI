...
function Initialize-ApplicationTestReport {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationTestReport' | Write-Debug
...
function ConvertFrom-JsonToApplicationTestReport {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationTestReport' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
