...
function Initialize-ApplicationTestCreate {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ApplicationTestCreate' | Write-Debug
...
function ConvertFrom-JsonToApplicationTestCreate {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ApplicationTestCreate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
