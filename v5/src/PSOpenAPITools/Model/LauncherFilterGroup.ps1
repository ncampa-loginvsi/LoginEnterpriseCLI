...
function Initialize-LauncherFilterGroup {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LauncherFilterGroup' | Write-Debug
...
function ConvertFrom-JsonToLauncherFilterGroup {
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LauncherFilterGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
