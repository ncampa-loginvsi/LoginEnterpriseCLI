...
------------- | ------------- | -------------
[**Invoke-DataGetAppExecutions**](AppExecutionApi.md#Invoke-DataGetAppExecutions) | **GET** /v5/test-runs/{testRunId}/user-sessions/{userSessionId}/app-executions | Get paginated list of app-executions
