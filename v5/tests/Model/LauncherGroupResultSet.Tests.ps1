...
Describe -tag 'PSOpenAPITools' -name 'LauncherGroupResultSet' {
    Context 'LauncherGroupResultSet' {
        It 'Initialize-LauncherGroupResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherGroupResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
