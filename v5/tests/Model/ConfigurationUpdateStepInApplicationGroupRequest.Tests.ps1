...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationUpdateStepInApplicationGroupRequest' {
    Context 'ConfigurationUpdateStepInApplicationGroupRequest' {
        It 'Initialize-ConfigurationUpdateStepInApplicationGroupRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationUpdateStepInApplicationGroupRequest -Type "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -IsEnabled "TEST_VALUE" -DelayInSeconds "TEST_VALUE"
