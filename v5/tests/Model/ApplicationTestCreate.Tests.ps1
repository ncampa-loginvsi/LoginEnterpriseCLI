...
Describe -tag 'PSOpenAPITools' -name 'ApplicationTestCreate' {
    Context 'ApplicationTestCreate' {
        It 'Initialize-ApplicationTestCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationTestCreate -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Connector "TEST_VALUE" -AccountGroups "TEST_VALUE" -LauncherGroups "TEST_VALUE"
