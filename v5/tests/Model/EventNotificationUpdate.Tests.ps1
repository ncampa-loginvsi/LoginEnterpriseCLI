...
Describe -tag 'PSOpenAPITools' -name 'EventNotificationUpdate' {
    Context 'EventNotificationUpdate' {
        It 'Initialize-EventNotificationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-EventNotificationUpdate -Type "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE"
