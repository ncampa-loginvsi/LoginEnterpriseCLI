...
Describe -tag 'PSOpenAPITools' -name 'EnvironmentUpdate' {
    Context 'EnvironmentUpdate' {
        It 'Initialize-EnvironmentUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-EnvironmentUpdate -Connector "TEST_VALUE" -LauncherGroups "TEST_VALUE" -AccountGroups "TEST_VALUE"
            #$NewObject | Should -BeOfType EnvironmentUpdate
