...
Describe -tag 'PSOpenAPITools' -name 'RdpConnector' {
    Context 'RdpConnector' {
        It 'Initialize-RdpConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-RdpConnector -Type "TEST_VALUE" -HostList "TEST_VALUE" -Resource "TEST_VALUE" -Gateway "TEST_VALUE" -SuppressCertWarn "TEST_VALUE" -DisplayResolution "TEST_VALUE"
