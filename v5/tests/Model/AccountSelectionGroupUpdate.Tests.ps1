...
Describe -tag 'PSOpenAPITools' -name 'AccountSelectionGroupUpdate' {
    Context 'AccountSelectionGroupUpdate' {
        It 'Initialize-AccountSelectionGroupUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountSelectionGroupUpdate -Type "TEST_VALUE" -MemberIds "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
