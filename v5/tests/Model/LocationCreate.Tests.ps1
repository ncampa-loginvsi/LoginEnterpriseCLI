...
Describe -tag 'PSOpenAPITools' -name 'LocationCreate' {
    Context 'LocationCreate' {
        It 'Initialize-LocationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-LocationCreate -Name "TEST_VALUE" -Latitude "TEST_VALUE" -Longitude "TEST_VALUE" -Description "TEST_VALUE"
