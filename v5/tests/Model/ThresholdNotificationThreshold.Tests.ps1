...
Describe -tag 'PSOpenAPITools' -name 'ThresholdNotificationThreshold' {
    Context 'ThresholdNotificationThreshold' {
        It 'Initialize-ThresholdNotificationThreshold' {
            # a simple test to create an object
            #$NewObject = Initialize-ThresholdNotificationThreshold -Type "TEST_VALUE" -ApplicationId "TEST_VALUE" -Timer "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE" -Target "TEST_VALUE"
            #$NewObject | Should -BeOfType ThresholdNotificationThreshold
