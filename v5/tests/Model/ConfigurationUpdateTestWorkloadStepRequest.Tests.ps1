...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationUpdateTestWorkloadStepRequest' {
    Context 'ConfigurationUpdateTestWorkloadStepRequest' {
        It 'Initialize-ConfigurationUpdateTestWorkloadStepRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationUpdateTestWorkloadStepRequest -Type "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -IsEnabled "TEST_VALUE" -DelayInSeconds "TEST_VALUE"
            #$NewObject | Should -BeOfType ConfigurationUpdateTestWorkloadStepRequest
