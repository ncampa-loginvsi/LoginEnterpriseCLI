...
Describe -tag 'PSOpenAPITools' -name 'TestResultSet' {
    Context 'TestResultSet' {
        It 'Initialize-TestResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-TestResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
