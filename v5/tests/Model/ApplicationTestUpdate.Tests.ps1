...
Describe -tag 'PSOpenAPITools' -name 'ApplicationTestUpdate' {
    Context 'ApplicationTestUpdate' {
        It 'Initialize-ApplicationTestUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationTestUpdate -Type "TEST_VALUE" -IsEmailEnabled "TEST_VALUE" -EmailRecipient "TEST_VALUE" -IncludeSuccessfulApplications "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -EnvironmentUpdate "TEST_VALUE" -Steps "TEST_VALUE"
