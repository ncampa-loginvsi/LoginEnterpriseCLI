...
Describe -tag 'PSOpenAPITools' -name 'AccountSelectionGroupCreate' {
    Context 'AccountSelectionGroupCreate' {
        It 'Initialize-AccountSelectionGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountSelectionGroupCreate -Type "TEST_VALUE" -MemberIds "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
