...
Describe -tag 'PSOpenAPITools' -name 'ReportConfigurationInclude' {
    Context 'ReportConfigurationInclude' {
        It 'Initialize-ReportConfigurationInclude' {
            # a simple test to create an object
            #$NewObject = Initialize-ReportConfigurationInclude
