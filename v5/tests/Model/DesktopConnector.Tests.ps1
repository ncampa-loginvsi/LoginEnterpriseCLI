...
Describe -tag 'PSOpenAPITools' -name 'DesktopConnector' {
    Context 'DesktopConnector' {
        It 'Initialize-DesktopConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-DesktopConnector -Type "TEST_VALUE"
