...
Describe -tag 'PSOpenAPITools' -name 'LauncherLocationUpdate' {
    Context 'LauncherLocationUpdate' {
        It 'Initialize-LauncherLocationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherLocationUpdate -LocationId "TEST_VALUE"
