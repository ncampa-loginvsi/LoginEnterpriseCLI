...
Describe -tag 'PSOpenAPITools' -name 'EnvironmentUpdateConnector' {
    Context 'EnvironmentUpdateConnector' {
        It 'Initialize-EnvironmentUpdateConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-EnvironmentUpdateConnector -Type "TEST_VALUE" -VarHost "TEST_VALUE" -CommandLine "TEST_VALUE" -ServerUrl "TEST_VALUE" -Resource "TEST_VALUE" -DisplayResolution "TEST_VALUE" -HostList "TEST_VALUE" -Gateway "TEST_VALUE" -SuppressCertWarn "TEST_VALUE"
            #$NewObject | Should -BeOfType EnvironmentUpdateConnector
