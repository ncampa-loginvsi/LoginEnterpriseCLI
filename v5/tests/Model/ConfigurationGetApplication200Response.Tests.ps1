...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationGetApplication200Response' {
    Context 'ConfigurationGetApplication200Response' {
        It 'Initialize-ConfigurationGetApplication200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationGetApplication200Response -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE" -Script "TEST_VALUE" -Timers "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE" -MainWindowTitle "TEST_VALUE" -MainProcessName "TEST_VALUE"
