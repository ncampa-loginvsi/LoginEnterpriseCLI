...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationGetContinuousTestNotifications200ResponseInner' {
    Context 'ConfigurationGetContinuousTestNotifications200ResponseInner' {
        It 'Initialize-ConfigurationGetContinuousTestNotifications200ResponseInner' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationGetContinuousTestNotifications200ResponseInner -Type "TEST_VALUE" -Threshold "TEST_VALUE" -Id "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -CooldownDuration "TEST_VALUE" -IsEnabled "TEST_VALUE" -VarEvent "TEST_VALUE" -LastModified "TEST_VALUE"
