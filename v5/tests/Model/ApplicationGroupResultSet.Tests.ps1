...
Describe -tag 'PSOpenAPITools' -name 'ApplicationGroupResultSet' {
    Context 'ApplicationGroupResultSet' {
        It 'Initialize-ApplicationGroupResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationGroupResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
