...
Describe -tag 'PSOpenAPITools' -name 'AppGroupReference' {
    Context 'AppGroupReference' {
        It 'Initialize-AppGroupReference' {
            # a simple test to create an object
            #$NewObject = Initialize-AppGroupReference -Type "TEST_VALUE" -ApplicationGroup "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE"
