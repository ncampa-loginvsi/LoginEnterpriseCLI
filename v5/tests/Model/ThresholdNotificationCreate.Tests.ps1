...
Describe -tag 'PSOpenAPITools' -name 'ThresholdNotificationCreate' {
    Context 'ThresholdNotificationCreate' {
        It 'Initialize-ThresholdNotificationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-ThresholdNotificationCreate -Type "TEST_VALUE" -Threshold "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE"
