...
Describe -tag 'PSOpenAPITools' -name 'UserSessionResultSet' {
    Context 'UserSessionResultSet' {
        It 'Initialize-UserSessionResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-UserSessionResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
