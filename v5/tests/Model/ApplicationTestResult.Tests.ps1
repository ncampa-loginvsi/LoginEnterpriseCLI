...
Describe -tag 'PSOpenAPITools' -name 'ApplicationTestResult' {
    Context 'ApplicationTestResult' {
        It 'Initialize-ApplicationTestResult' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationTestResult
