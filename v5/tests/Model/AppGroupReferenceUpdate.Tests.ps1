...
Describe -tag 'PSOpenAPITools' -name 'AppGroupReferenceUpdate' {
    Context 'AppGroupReferenceUpdate' {
        It 'Initialize-AppGroupReferenceUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-AppGroupReferenceUpdate -Type "TEST_VALUE" -IsEnabled "TEST_VALUE"
