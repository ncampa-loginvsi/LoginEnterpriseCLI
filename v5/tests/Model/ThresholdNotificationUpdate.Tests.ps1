...
Describe -tag 'PSOpenAPITools' -name 'ThresholdNotificationUpdate' {
    Context 'ThresholdNotificationUpdate' {
        It 'Initialize-ThresholdNotificationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-ThresholdNotificationUpdate -Type "TEST_VALUE" -ThresholdUpdate "TEST_VALUE" -TimesExceeded "TEST_VALUE" -PeriodDuration "TEST_VALUE" -IsEnabled "TEST_VALUE"
