...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationCreateTestRequest' {
    Context 'ConfigurationCreateTestRequest' {
        It 'Initialize-ConfigurationCreateTestRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationCreateTestRequest -Type "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Connector "TEST_VALUE" -AccountGroups "TEST_VALUE" -LauncherGroups "TEST_VALUE"
