...
Describe -tag 'PSOpenAPITools' -name 'WebApplicationCreate' {
    Context 'WebApplicationCreate' {
        It 'Initialize-WebApplicationCreate' {
            ...
            #$NewObject = Initialize-WebApplicationCreate -Type "TEST_VALUE" -BrowserName "TEST_VALUE" -Url "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE"
