...
Describe -tag 'PSOpenAPITools' -name 'ContinuousScheduleType' {
    Context 'ContinuousScheduleType' {
        It 'Initialize-ContinuousScheduleType' {
            # a simple test to create an object
            #$NewObject = Initialize-ContinuousScheduleType
