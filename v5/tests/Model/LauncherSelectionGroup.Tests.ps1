...
Describe -tag 'PSOpenAPITools' -name 'LauncherSelectionGroup' {
    Context 'LauncherSelectionGroup' {
        It 'Initialize-LauncherSelectionGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherSelectionGroup -Type "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Members "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE"
