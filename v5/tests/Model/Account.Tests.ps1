...
Describe -tag 'PSOpenAPITools' -name 'Account' {
    Context 'Account' {
        It 'Initialize-Account' {
            ...
            #$NewObject = Initialize-Account -Id "TEST_VALUE" -Username "TEST_VALUE" -Domain "TEST_VALUE" -Email "TEST_VALUE" -Created "TEST_VALUE" -Groups "TEST_VALUE" -Fields "TEST_VALUE" -InUse "TEST_VALUE" -Enabled "TEST_VALUE"
