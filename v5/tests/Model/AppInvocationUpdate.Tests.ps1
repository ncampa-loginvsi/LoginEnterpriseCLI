...
Describe -tag 'PSOpenAPITools' -name 'AppInvocationUpdate' {
    Context 'AppInvocationUpdate' {
        It 'Initialize-AppInvocationUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-AppInvocationUpdate -Type "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -IsEnabled "TEST_VALUE"
