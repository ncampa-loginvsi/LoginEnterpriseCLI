...
Describe -tag 'PSOpenAPITools' -name 'DelayCreate' {
    Context 'DelayCreate' {
        It 'Initialize-DelayCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-DelayCreate -Type "TEST_VALUE" -DelayInSeconds "TEST_VALUE" -IsEnabled "TEST_VALUE"
