...
Describe -tag 'PSOpenAPITools' -name 'AppExecutionResultSet' {
    Context 'AppExecutionResultSet' {
        It 'Initialize-AppExecutionResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-AppExecutionResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
