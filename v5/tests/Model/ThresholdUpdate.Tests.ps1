...
Describe -tag 'PSOpenAPITools' -name 'ThresholdUpdate' {
    Context 'ThresholdUpdate' {
        It 'Initialize-ThresholdUpdate' {
            # a simple test to create an object
            #$NewObject = Initialize-ThresholdUpdate -IsEnabled "TEST_VALUE" -Value "TEST_VALUE"
