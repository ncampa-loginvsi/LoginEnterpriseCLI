...
Describe -tag 'PSOpenAPITools' -name 'SuccessRate' {
    Context 'SuccessRate' {
        It 'Initialize-SuccessRate' {
            # a simple test to create an object
            #$NewObject = Initialize-SuccessRate -Failed "TEST_VALUE" -Total "TEST_VALUE" -Percentage "TEST_VALUE"
