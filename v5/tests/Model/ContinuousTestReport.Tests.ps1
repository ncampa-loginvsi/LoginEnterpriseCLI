...
Describe -tag 'PSOpenAPITools' -name 'ContinuousTestReport' {
    Context 'ContinuousTestReport' {
        It 'Initialize-ContinuousTestReport' {
            # a simple test to create an object
            #$NewObject = Initialize-ContinuousTestReport -Type "TEST_VALUE" -ConfigurationId "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -OutputContentUri "TEST_VALUE" -State "TEST_VALUE" -Trigger "TEST_VALUE" -Created "TEST_VALUE" -ReportPeriodStart "TEST_VALUE" -ReportPeriodEnd "TEST_VALUE"
