...
Describe -tag 'PSOpenAPITools' -name 'SessionThresholdType' {
    Context 'SessionThresholdType' {
        It 'Initialize-SessionThresholdType' {
            # a simple test to create an object
            #$NewObject = Initialize-SessionThresholdType
