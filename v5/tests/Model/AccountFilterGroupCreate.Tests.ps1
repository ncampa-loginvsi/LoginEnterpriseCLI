...
Describe -tag 'PSOpenAPITools' -name 'AccountFilterGroupCreate' {
    Context 'AccountFilterGroupCreate' {
        It 'Initialize-AccountFilterGroupCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountFilterGroupCreate -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
