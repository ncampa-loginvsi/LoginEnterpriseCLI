...
Describe -tag 'PSOpenAPITools' -name 'AppInvocation' {
    Context 'AppInvocation' {
        It 'Initialize-AppInvocation' {
            # a simple test to create an object
            #$NewObject = Initialize-AppInvocation -Type "TEST_VALUE" -Application "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE"
