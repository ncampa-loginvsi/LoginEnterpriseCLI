...
Describe -tag 'PSOpenAPITools' -name 'StorefrontConnector' {
    Context 'StorefrontConnector' {
        It 'Initialize-StorefrontConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-StorefrontConnector -Type "TEST_VALUE" -ServerUrl "TEST_VALUE" -Resource "TEST_VALUE" -DisplayResolution "TEST_VALUE"
