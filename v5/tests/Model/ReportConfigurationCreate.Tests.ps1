...
Describe -tag 'PSOpenAPITools' -name 'ReportConfigurationCreate' {
    Context 'ReportConfigurationCreate' {
        It 'Initialize-ReportConfigurationCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-ReportConfigurationCreate -Frequency "TEST_VALUE" -LatencyThreshold "TEST_VALUE" -LoginTimeThreshold "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -IsEnabled "TEST_VALUE" -Notification "TEST_VALUE"
