...
Describe -tag 'PSOpenAPITools' -name 'LocationResultSet' {
    Context 'LocationResultSet' {
        It 'Initialize-LocationResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LocationResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
