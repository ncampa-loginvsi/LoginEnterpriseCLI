...
Describe -tag 'PSOpenAPITools' -name 'ApplicationTestRun' {
    Context 'ApplicationTestRun' {
        It 'Initialize-ApplicationTestRun' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationTestRun -Type "TEST_VALUE" -State "TEST_VALUE" -Result "TEST_VALUE" -AppFailureResults "TEST_VALUE" -AppPerformanceResults "TEST_VALUE" -Properties "TEST_VALUE" -Comment "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -Created "TEST_VALUE" -Started "TEST_VALUE" -Finished "TEST_VALUE" -Counter "TEST_VALUE"
