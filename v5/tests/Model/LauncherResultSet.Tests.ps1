...
Describe -tag 'PSOpenAPITools' -name 'LauncherResultSet' {
    Context 'LauncherResultSet' {
        It 'Initialize-LauncherResultSet' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherResultSet -Items "TEST_VALUE" -TotalCount "TEST_VALUE" -Offset "TEST_VALUE"
