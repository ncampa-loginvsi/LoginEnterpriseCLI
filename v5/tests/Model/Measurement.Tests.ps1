...
Describe -tag 'PSOpenAPITools' -name 'Measurement' {
    Context 'Measurement' {
        It 'Initialize-Measurement' {
            # a simple test to create an object
            #$NewObject = Initialize-Measurement -MeasurementId "TEST_VALUE" -AppExecutionId "TEST_VALUE" -ApplicationId "TEST_VALUE" -LauncherName "TEST_VALUE" -AccountId "TEST_VALUE" -TestRunId "TEST_VALUE" -UserSessionId "TEST_VALUE" -Duration "TEST_VALUE" -Timestamp "TEST_VALUE" -Properties "TEST_VALUE"
