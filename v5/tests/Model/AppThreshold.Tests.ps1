...
Describe -tag 'PSOpenAPITools' -name 'AppThreshold' {
    Context 'AppThreshold' {
        It 'Initialize-AppThreshold' {
            # a simple test to create an object
            #$NewObject = Initialize-AppThreshold -Type "TEST_VALUE" -ApplicationId "TEST_VALUE" -Timer "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -Value "TEST_VALUE" -LastModified "TEST_VALUE"
