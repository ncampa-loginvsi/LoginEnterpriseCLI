...
Describe -tag 'PSOpenAPITools' -name 'LoadTestUpdate' {
    Context 'LoadTestUpdate' {
        It 'Initialize-LoadTestUpdate' {
            ...
            #$NewObject = Initialize-LoadTestUpdate -Type "TEST_VALUE" -NumberOfSessions "TEST_VALUE" -RampUpDurationInMinutes "TEST_VALUE" -TestDurationInMinutes "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -EnvironmentUpdate "TEST_VALUE" -Steps "TEST_VALUE"
