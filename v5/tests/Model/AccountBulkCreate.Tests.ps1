...
Describe -tag 'PSOpenAPITools' -name 'AccountBulkCreate' {
    Context 'AccountBulkCreate' {
        It 'Initialize-AccountBulkCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-AccountBulkCreate -NumberOfDigits "TEST_VALUE" -NumberOfAccounts "TEST_VALUE" -Username "TEST_VALUE" -Domain "TEST_VALUE" -Email "TEST_VALUE" -Password "TEST_VALUE" -Fields "TEST_VALUE"
