...
Describe -tag 'PSOpenAPITools' -name 'HorizonConnector' {
    Context 'HorizonConnector' {
        It 'Initialize-HorizonConnector' {
            # a simple test to create an object
            #$NewObject = Initialize-HorizonConnector -Type "TEST_VALUE" -ServerUrl "TEST_VALUE" -Resource "TEST_VALUE" -CommandLine "TEST_VALUE"
