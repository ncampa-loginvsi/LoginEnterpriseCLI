...
Describe -tag 'PSOpenAPITools' -name 'DataGetApplicationTestReport200Response' {
    Context 'DataGetApplicationTestReport200Response' {
        It 'Initialize-DataGetApplicationTestReport200Response' {
            # a simple test to create an object
            #$NewObject = Initialize-DataGetApplicationTestReport200Response -Type "TEST_VALUE" -TestRunId "TEST_VALUE" -Id "TEST_VALUE" -TestId "TEST_VALUE" -OutputContentUri "TEST_VALUE" -State "TEST_VALUE" -Trigger "TEST_VALUE" -Created "TEST_VALUE" -ReportPeriodStart "TEST_VALUE" -ReportPeriodEnd "TEST_VALUE" -ConfigurationId "TEST_VALUE"
