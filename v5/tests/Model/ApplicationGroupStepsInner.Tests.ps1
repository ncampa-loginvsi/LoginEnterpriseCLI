...
Describe -tag 'PSOpenAPITools' -name 'ApplicationGroupStepsInner' {
    Context 'ApplicationGroupStepsInner' {
        It 'Initialize-ApplicationGroupStepsInner' {
            # a simple test to create an object
            #$NewObject = Initialize-ApplicationGroupStepsInner -Type "TEST_VALUE" -Application "TEST_VALUE" -RunOnce "TEST_VALUE" -LeaveRunning "TEST_VALUE" -Id "TEST_VALUE" -IsEnabled "TEST_VALUE" -DelayInSeconds "TEST_VALUE" -ApplicationGroup "TEST_VALUE"
