...
Describe -tag 'PSOpenAPITools' -name 'LauncherFilterGroupData' {
    Context 'LauncherFilterGroupData' {
        It 'Initialize-LauncherFilterGroupData' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherFilterGroupData -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
