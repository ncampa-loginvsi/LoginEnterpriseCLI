...
Describe -tag 'PSOpenAPITools' -name 'ConfigurationCreateAccountGroupRequest' {
    Context 'ConfigurationCreateAccountGroupRequest' {
        It 'Initialize-ConfigurationCreateAccountGroupRequest' {
            # a simple test to create an object
            #$NewObject = Initialize-ConfigurationCreateAccountGroupRequest -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -MemberIds "TEST_VALUE"
