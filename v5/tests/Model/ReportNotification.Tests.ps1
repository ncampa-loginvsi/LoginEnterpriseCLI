...
Describe -tag 'PSOpenAPITools' -name 'ReportNotification' {
    Context 'ReportNotification' {
        It 'Initialize-ReportNotification' {
            # a simple test to create an object
            #$NewObject = Initialize-ReportNotification -IsEnabled "TEST_VALUE" -Recipient "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE"
