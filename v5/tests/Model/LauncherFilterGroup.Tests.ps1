...
Describe -tag 'PSOpenAPITools' -name 'LauncherFilterGroup' {
    Context 'LauncherFilterGroup' {
        It 'Initialize-LauncherFilterGroup' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherFilterGroup -Type "TEST_VALUE" -VarFilter "TEST_VALUE" -Id "TEST_VALUE" -Name "TEST_VALUE" -MemberCount "TEST_VALUE" -Description "TEST_VALUE" -Members "TEST_VALUE" -Created "TEST_VALUE" -LastModified "TEST_VALUE"
