...
Describe -tag 'PSOpenAPITools' -name 'WindowsApplicationCreate' {
    Context 'WindowsApplicationCreate' {
        It 'Initialize-WindowsApplicationCreate' {
            ...
            #$NewObject = Initialize-WindowsApplicationCreate -Type "TEST_VALUE" -CommandLine "TEST_VALUE" -WorkingDirectory "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE" -Username "TEST_VALUE" -Password "TEST_VALUE"
