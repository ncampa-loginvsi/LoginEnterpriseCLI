...
Describe -tag 'PSOpenAPITools' -name 'LauncherSelectionGroupData' {
    Context 'LauncherSelectionGroupData' {
        It 'Initialize-LauncherSelectionGroupData' {
            # a simple test to create an object
            #$NewObject = Initialize-LauncherSelectionGroupData -Type "TEST_VALUE" -LauncherNames "TEST_VALUE" -Name "TEST_VALUE" -Description "TEST_VALUE"
