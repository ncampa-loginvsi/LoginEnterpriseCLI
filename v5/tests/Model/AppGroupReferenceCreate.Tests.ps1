...
Describe -tag 'PSOpenAPITools' -name 'AppGroupReferenceCreate' {
    Context 'AppGroupReferenceCreate' {
        It 'Initialize-AppGroupReferenceCreate' {
            # a simple test to create an object
            #$NewObject = Initialize-AppGroupReferenceCreate -Type "TEST_VALUE" -ApplicationGroupId "TEST_VALUE" -IsEnabled "TEST_VALUE"
