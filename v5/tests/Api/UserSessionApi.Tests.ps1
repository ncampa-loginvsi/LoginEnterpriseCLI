...
Describe -tag 'PSOpenAPITools' -name 'UserSessionApi' {
    ...
    Context 'Invoke-DataGetUserSessions' {
        It 'Test Invoke-DataGetUserSessions' {
            #$TestResult = Invoke-DataGetUserSessions -TestRunId "TEST_VALUE" -Direction "TEST_VALUE" -Count "TEST_VALUE" -Offset "TEST_VALUE" -IncludeTotalCount "TEST_VALUE" -From "TEST_VALUE" -To "TEST_VALUE" -Include "TEST_VALUE"
            #$TestResult | Should -BeOfType TODO
            #$TestResult.property | Should -Be 0
        }
    }
